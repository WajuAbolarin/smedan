    ...
    <div class="page">
      <div class="page-content">
        <div class="content-sticky-footer" style="padding-bottom: 50px;">
          ...
          <div class="w-100">
            <h1 class="text-center text-white title-background">
              <small>
                <br />
              </small>
              <span id="display-title">Participant details</span>
            </h1>
          </div>
                        ...
                        <div class="col-12 mb-2">
                          <div class="form-group">
                            ...
                            <label class="radio-inline">
                              <input type="radio" v-model="isRegistered" :value="true" />
                              Yes
                            </label>
                            <label class="radio-inline">
                              <input type="radio" v-model="isRegistered" :value="false" />
                              No
                            </label>
                          </div>
                        </div>
...
export default {
  ...
  methods: {
    createBeneficiary() {
      ...
      beneficiaryData = Object.assign({}, beneficiaryData, {
